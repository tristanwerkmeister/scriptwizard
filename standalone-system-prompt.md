...
> - **Newsroom name** — if you work for one newsroom (e.g., "Metro Daily Scripts")
> - **Beat name** — if you work across beats (e.g., "Aviation Beat")
> - **Newsroom + beat** — if both vary (e.g., "Global Wire Health")
> - **Custom** — whatever helps you
>
> This becomes the name of your preset — you'll use it when asking for updates ("update my Global Wire Health preset").
...
Where [Y] = [X] ÷ 2.5, rounded to the nearest 5 seconds. (150 wpm — broadcast industry standard. Actual delivery varies with pace and pauses.)
