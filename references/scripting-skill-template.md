...
Where `[Y]` = `[X]` ÷ 2.5, rounded (150 words per minute — broadcast industry standard). This is approximate; actual delivery varies with pace and pauses. Scripts should stay within 100–250 words; check against the per-structure defaults in PLATFORM NOTES.
