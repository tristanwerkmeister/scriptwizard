...
This is a Script Wizard preset. It captures the voice, standards, style, and publication context for **{PRESET_NAME}**.

When this preset is loaded, everything below governs how scripts are drafted.
